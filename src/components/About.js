...
const About = () => {
    return (
        <div className="container p-3" id="about">
            <h1 className="display-6 sub-title" data-aos="fade-up">I'm <span className="bold">Madeleine</span> and I am studying <span className="italic">web
                development</span> at the <span className="italic">University of
                    Adelaide</span> coding bootcamp.</h1>
